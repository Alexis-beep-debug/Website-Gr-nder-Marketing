  ...
  return (
    <section id="kontakt" className="py-24 sm:py-32 bg-section-alt">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="bg-accent/[0.06] border border-accent/15 rounded-lg p-6 sm:p-10 md:p-16 text-center relative overflow-hidden">
          {/* Decorative circles */}
          ...
          <div className="relative z-10">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
              ...
              <a
                ...
                className="border-2 border-accent/20 text-primary/70 hover:border-accent hover:text-accent px-6 sm:px-10 py-3.5 sm:py-4 rounded-lg text-base sm:text-lg font-semibold transition-all flex items-center justify-center gap-3 w-full sm:w-auto"
              >
                <svg
                  className="w-5 h-5"
                  fill="none"
